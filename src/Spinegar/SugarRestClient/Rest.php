...
class Rest
{
     ...
     */
    public function search($module, $parameters = [])
    {
        $endpoint = $module;
     ...
     */
    public function filter($module, $parameters = [])
    {
     ...
     */
    public function countRecords($module, $parameters = [])
    {
     ...
     * Returns:  Returns an Array if successful, otherwise FALSE
     */
    public function related($module, $record, $link, $parameters = [])
    {
     ...
     * Returns:  Returns an Array if successful, otherwise FALSE
     */
    public function relate($module, $record, $link, $related_record, $fields = [])
    {
     ...
     * Returns:  Returns an Array if successful, otherwise FALSE
     */
    public function updateRelationship($module, $record, $link, $related_record, $fields = [])
    {
        $endpoint = $module . '/' . $record . '/link/' . $link . '/' . $related_record;
     ...
     * Returns:  Returns ARRAY if successful, otherwise FALSE
     */
    public function getEndpoint($endpoint, $parameters = [])
    {
        return $this->client->get($endpoint, $parameters);
    }
     ...
     * Returns:  Returns ARRAY if successful, otherwise FALSE
     */
    public function postEndpoint($endpoint, $parameters = [])
    {
     ...
     * Returns:  Returns ARRAY if successful, otherwise FALSE
     */
    public function putEndpoint($endpoint, $parameters = [])
    {
     ...
     * Returns:  Returns ARRAY if successful, otherwise FALSE
     */
    public function deleteEndpoint($endpoint, $parameters = [])
    {
